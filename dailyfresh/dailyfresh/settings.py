...
SECRET_KEY = 'si*91b91s!ip7wbhl%6dmkc6ki!+e0f9m@$t%05xk2jnvc490l'
...
# ckeditor的ckeditor-init.js文件中使用了JQuery，所以要在settings.py中设置CKEDITOR_JQUERY_URL来指定JQuery库的路径
...
#收件人看到的发件人
EMAIL_FROM = '天天生鲜<suptest005@163.com>'
